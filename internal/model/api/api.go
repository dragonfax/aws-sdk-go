...
func (a *API) resetImports() {
	a.imports = map[string]bool{
		"github.com/dragonfax/aws-sdk-go/aws": true,
	}
}
...
func (a *API) APIGoCode() string {
	a.resetImports()
	delete(a.imports, "github.com/dragonfax/aws-sdk-go/aws")
	a.imports["github.com/dragonfax/aws-sdk-go/aws/awsutil"] = true
	a.imports["github.com/dragonfax/aws-sdk-go/aws/request"] = true
...
func (a *API) ServiceGoCode() string {
	a.resetImports()
	a.imports["github.com/dragonfax/aws-sdk-go/aws"] = true
	a.imports["github.com/dragonfax/aws-sdk-go/aws/defaults"] = true
	a.imports["github.com/dragonfax/aws-sdk-go/aws/request"] = true
	a.imports["github.com/dragonfax/aws-sdk-go/aws/service"] = true
	a.imports["github.com/dragonfax/aws-sdk-go/aws/service/serviceinfo"] = true
	a.imports["github.com/dragonfax/aws-sdk-go/internal/signer/v4"] = true
	a.imports["github.com/dragonfax/aws-sdk-go/internal/protocol/"+a.ProtocolPackage()] = true
...
func (a *API) ExampleGoCode() string {
	...
	code := fmt.Sprintf("import (\n%q\n%q\n%q\n\n%q\n%q\n)\n\n"+
		...
		"github.com/dragonfax/aws-sdk-go/service/"+a.PackageName(),
		strings.Join(exs, "\n\n"),
	)
	return code
}
...
func (a *API) InterfaceGoCode() string {
	a.resetImports()
	a.imports = map[string]bool{
		"github.com/dragonfax/aws-sdk-go/aws/request":                true,
		"github.com/dragonfax/aws-sdk-go/service/" + a.PackageName(): true,
	}
...
func (a *API) InterfaceTestGoCode() string {
	...
	a.imports = map[string]bool{
		"testing": true,
		"github.com/dragonfax/aws-sdk-go/service/" + a.PackageName():                                  true,
		"github.com/dragonfax/aws-sdk-go/service/" + a.PackageName() + "/" + a.InterfacePackageName(): true,
