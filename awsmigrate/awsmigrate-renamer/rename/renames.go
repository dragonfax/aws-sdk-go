...
var renamedPackages = map[string]*packageRenames{
	...
	"github.com/dragonfax/aws-sdk-go/service/autoscaling/autoscalingiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/cloudformation/cloudformationiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/cloudfront/cloudfrontiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/cloudhsm/cloudhsmiface": {
		operations: map[string]string{
			"CreateHAPG":          "CreateHapg",
			"CreateHAPGPages":     "CreateHapgPages",
			"CreateHAPGRequest":   "CreateHapgRequest",
	...
	"github.com/dragonfax/aws-sdk-go/service/cloudsearch/cloudsearchiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/cloudsearchdomain/cloudsearchdomainiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/cloudtrail/cloudtrailiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/cloudwatch/cloudwatchiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/cloudwatchlogs/cloudwatchlogsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/codecommit/codecommitiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/codedeploy/codedeployiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/codepipeline/codepipelineiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/cognitoidentity/cognitoidentityiface": {
		operations: map[string]string{
			"GetID":                                     "GetId",
			"GetIDPages":                                "GetIdPages",
			"GetIDRequest":                              "GetIdRequest",
	...
	"github.com/dragonfax/aws-sdk-go/service/cognitosync/cognitosynciface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/configservice/configserviceiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/datapipeline/datapipelineiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/directconnect/directconnectiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/directoryservice/directoryserviceiface": {
		operations: map[string]string{
			"DisableSSO":        "DisableSso",
			"DisableSSOPages":   "DisableSsoPages",
			"DisableSSORequest": "DisableSsoRequest",
	...
	"github.com/dragonfax/aws-sdk-go/service/dynamodb/dynamodbiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/ec2/ec2iface": {
		operations: map[string]string{
			"AcceptVPCPeeringConnection":           "AcceptVpcPeeringConnection",
			"AcceptVPCPeeringConnectionPages":      "AcceptVpcPeeringConnectionPages",
			"AcceptVPCPeeringConnectionRequest":    "AcceptVpcPeeringConnectionRequest",
	...
	"github.com/dragonfax/aws-sdk-go/service/ecs/ecsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/elasticache/elasticacheiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/elasticbeanstalk/elasticbeanstalkiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/elastictranscoder/elastictranscoderiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/emr/emriface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/glacier/glacieriface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/iam/iamiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/kinesis/kinesisiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/kms/kmsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/lambda/lambdaiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/machinelearning/machinelearningiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/mobileanalytics/mobileanalyticsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/opsworks/opsworksiface": {
		operations: map[string]string{
			"AssociateElasticIP":             "AssociateElasticIp",
			"AssociateElasticIPPages":        "AssociateElasticIpPages",
			"AssociateElasticIPRequest":      "AssociateElasticIpRequest",
	...
	"github.com/dragonfax/aws-sdk-go/service/rds/rdsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/redshift/redshiftiface": {
		operations: map[string]string{
			"CreateHSMClientCertificate":           "CreateHsmClientCertificate",
			"CreateHSMClientCertificatePages":      "CreateHsmClientCertificatePages",
			"CreateHSMClientCertificateRequest":    "CreateHsmClientCertificateRequest",
	...
	"github.com/dragonfax/aws-sdk-go/service/route53/route53iface": {
		operations: map[string]string{
			"GetCheckerIPRanges":        "GetCheckerIpRanges",
			"GetCheckerIPRangesPages":   "GetCheckerIpRangesPages",
			"GetCheckerIPRangesRequest": "GetCheckerIpRangesRequest",
	...
	"github.com/dragonfax/aws-sdk-go/service/route53domains/route53domainsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/s3/s3iface": {
		operations: map[string]string{
			"DeleteBucketCORS":        "DeleteBucketCors",
			"DeleteBucketCORSPages":   "DeleteBucketCorsPages",
			"DeleteBucketCORSRequest": "DeleteBucketCorsRequest",
	...
	"github.com/dragonfax/aws-sdk-go/service/sns/snsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/sqs/sqsiface": {
		operations: map[string]string{
			"GetQueueURL":        "GetQueueUrl",
			"GetQueueURLPages":   "GetQueueUrlPages",
			"GetQueueURLRequest": "GetQueueUrlRequest",
	...
	"github.com/dragonfax/aws-sdk-go/service/ssm/ssmiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/sts/stsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/support/supportiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/swf/swfiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/dragonfax/aws-sdk-go/service/workspaces/workspacesiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
